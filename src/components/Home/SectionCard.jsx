...
export default function SectionCard(params) {
    ...
    return(
        ...
        <div className="container mx-auto px-6 flex-col relative pt-[50px]">
          <div className="rounded-lg pt-[45px] mb-8">
            <a href="#" className="bg-blue-100 text-[#48a259] text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-200 dark:text-[#48a259] mb-2">
