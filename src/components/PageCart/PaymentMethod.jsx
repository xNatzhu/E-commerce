export default function PaymentMethod(params) {
    return(
        ...
        <div className="p-6 border border-blue-100 dark:bg-[#17130F] dark:border-[#17130F] shadow rounded-xl bg-blue-50 md:p-8">
          ...
          <div className="flex items-center justify-between pb-4 mb-4">
            <span className="text-gray-700 dark:text-gray-400">Envio</span>
          ...
          <h2 className="text-lg text-gray-500 dark:text-gray-400">Metodo de pago:</h2>
          ...
          <div className="flex items-center justify-between">
            <button className="block w-full py-4 font-bold text-center text-gray-100 uppercase bg-[#48a259] rounded-md hover-bg-blue-600">Comprar</button>
          </div>
        </div>
      </div>
    )
